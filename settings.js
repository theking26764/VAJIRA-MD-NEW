...
const FOOTERNAME = 'Johnny King';
global.owner = process.env.OWNER_NUMBER  || '2348033654467' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=rZMR0YwB#fxb_AgqAZstq4rfGJNm-mhobB_RT47kDoOfGaVpHbbQ' ,
